...
function ProductList() {
  ...
  const handleAddToCart = (plant) => {
    ...
    setAddedItems(new Set(addedItems).add(plant.name)); 
            ...
            <div className="product-list" key={category.category}>
              ...
              <div className="product-card">
                {category.plants.map((plant) => (
                  <div className="product-title" key={plant.name}>
                    <img
                      src={plant.image}
                      alt={plant.name}
                    ...
                    <button
                      ...
                      disabled={addedItems.has(plant.name)} // Disable if item is in the set
                    >
                      {addedItems.has(plant.name) ? "Added" : "Add to Cart"}
                    </button>
                  </div>
                ))}
              </div>
